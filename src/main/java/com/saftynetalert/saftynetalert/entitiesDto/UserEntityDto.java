...
public class UserEntityDto {
    ...
    public UserEntityDto(long id, String firstname, String lastname, Date birthdate, String phone, String email, Role role, Address address, MedicalRecord medicalRecord) {
        this.id = id;
